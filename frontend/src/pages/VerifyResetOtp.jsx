...
import { ArrowLeft, CheckCircle, Sparkles, ArrowRight, Lock } from 'lucide-react'
...
const VerifyResetOtp = () => {
    ...
    const verifyResetHeroPanelStyle = darkMode
        ? {
    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="w-full max-w-[950px] mt-11 flex flex-col md:flex-row bg-white/95 dark:bg-[rgba(20,30,50,0.4)] shadow-[0_40px_120px_rgba(0,0,0,0.15)] dark:shadow-[0_40px_120px_rgba(0,0,0,0.5)] relative z-10 overflow-hidden max-h-[90vh] border border-white/50 dark:border-white/10 rounded-3xl backdrop-blur-xl"
            >
                {/* Left Panel */}
                <div className="hidden md:flex md:w-[45%] relative overflow-hidden flex-col justify-between p-12 lg:p-14" style={verifyResetHeroPanelStyle}>
                    ...
                    <div className="relative z-10 max-w-[300px]">
                        ...
                        <p className="text-white/90 text-[0.98rem] leading-relaxed max-w-[280px] font-light">
                            Confirm your identity with the code sent to your email.
                        </p>
                    </div>
                    ...
                    <div className="relative z-10 rounded-2xl border border-white/25 bg-gradient-to-br from-white/12 to-white/5 backdrop-blur-xl px-6 py-5 shadow-[0_16px_40px_rgba(0,0,0,0.2)] hover:border-white/35 transition-all duration-300">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-white font-semibold text-sm">Quick Verification</p>
                                <p className="text-white/75 text-xs mt-0.5">6-digit code expires in 10 minutes.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="mb-12 relative">
                            <div className="inline-block mb-3">
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-[#ffc966]/20 to-[#64c8ff]/20 border border-[#ffc966]/30 dark:border-[#ffc966]/40">
                                    ...
                                    <span className="text-[0.7rem] font-bold text-[#a1804a] dark:text-[#ffc966] tracking-widest uppercase">Code Verification</span>
                                </div>
                            </div>
                            ...
                            <p className="text-[0.87rem] text-gray-600 dark:text-gray-300 font-light leading-relaxed">
                                Enter the 6-digit code sent to <strong className="text-[#0a0f19] dark:text-white">{email}</strong>
                            </p>
                        </div>

                        <form onSubmit={handleVerify} className="space-y-8">
                            <div>
                                <label className="block text-[0.65rem] font-bold text-gray-500 dark:text-gray-400 tracking-widest uppercase mb-4">
                                    Recovery Code
                                </label>
                                <input
                                    type="text"
                                    ...
                                    placeholder="000000"
                                    className="w-full bg-transparent border-0 border-b-2 border-gray-300 dark:border-gray-600 px-0 py-4 text-center text-4xl tracking-[0.8em] text-[#0a0f19] dark:text-white focus:ring-0 focus:border-[#ffc966] dark:focus:border-[#ffc966] transition-colors placeholder-gray-300 dark:placeholder-gray-600 outline-none font-bold"
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-2">
                                <div className="text-sm font-medium">
                                    ...
                                    <span className={`font-bold ml-1 ${secondsLeft < 60 ? 'text-red-500 animate-pulse' : 'text-[#ffc966]'}`}>
                            ...
                            >
                                ...
                                {isSubmitting ? <Loader size="sm" /> : (
                                    <>
                                        Verify & Proceed <ArrowRight size={16} strokeWidth={2.5} />
                                    </>
                                )}
                            </button>
                        </form>

                        <div className="mt-8 space-y-3 border-t border-gray-300/40 dark:border-white/15 pt-8">
                            <button
                                type="button"
                                onClick={handleResend}
                                disabled={isResending}
                                className="w-full text-sm font-bold text-[#ffc966] hover:text-[#ffb84d] dark:hover:text-[#ffd480] transition-colors disabled:opacity-50 py-3 uppercase tracking-wide"
                            >
                                {isResending ? 'Resending Code...' : 'Resend Code'}
                            </button>
                            <Link
                                to="/forgot-password"
                                className="w-full block text-center text-sm font-bold text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300 transition-colors py-3 uppercase tracking-wide"
                            >
                                Try Different Email
                            </Link>
                        </div>
                        ...
                        <div className="mt-8 flex items-center justify-center gap-10 border-t border-gray-300/40 dark:border-white/15 pt-8">
                            <div className="flex flex-col items-center gap-2 group cursor-pointer">
                                <div className="p-2 rounded-lg bg-gradient-to-br from-[#ffc966]/10 to-[#64c8ff]/10 group-hover:from-[#ffc966]/20 group-hover:to-[#64c8ff]/20 transition-all">
                                    <Lock size={18} className="text-gray-600 dark:text-gray-300 group-hover:text-[#ffc966] dark:group-hover:text-[#ffc966] transition-colors" />
                                </div>
                            ...
                            <div className="flex flex-col items-center gap-2 group cursor-pointer">
                                <div className="p-2 rounded-lg bg-gradient-to-br from-[#ffc966]/10 to-[#64c8ff]/10 group-hover:from-[#ffc966]/20 group-hover:to-[#64c8ff]/20 transition-all">
                                    <CheckCircle size={18} className="text-gray-600 dark:text-gray-300 group-hover:text-[#64c8ff] dark:group-hover:text-[#64c8ff] transition-colors" />
                                </div>
