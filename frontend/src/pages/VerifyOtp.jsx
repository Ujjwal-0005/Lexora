...
const VerifyOtp = () => {
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            if (user) {
                const path = user.role === 'admin' ? '/admin/dashboard' : user.role === 'lawyer' ? '/lawyer/dashboard' : '/client/dashboard'
                navigate(path)
            }
        } catch (err) {
            // handled in hook
    ...
    const verifyHeroPanelStyle = darkMode
        ? {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="hidden md:flex md:w-[45%] relative overflow-hidden flex-col justify-between p-12 lg:p-14" style={verifyHeroPanelStyle}>
                    ...
                    <div className="relative z-10 max-w-[300px]">
                        ...
                        <p className="text-white/90 text-[0.98rem] leading-relaxed max-w-[280px] font-light">
                            Complete the final authentication step to unlock your digital vault.
                        </p>
                    </div>
                    ...
                    <div className="relative z-10 rounded-2xl border border-white/25 bg-gradient-to-br from-white/12 to-white/5 backdrop-blur-xl px-6 py-5 shadow-[0_16px_40px_rgba(0,0,0,0.2)] hover:border-white/35 transition-all duration-300">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-white font-semibold text-sm">Email Verified</p>
                                <p className="text-white/75 text-xs mt-0.5">Your verification code confirms your identity.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-[420px] relative z-10 bg-white/60 dark:bg-white/5 rounded-2xl p-8 lg:p-10 backdrop-blur-md border border-white/40 dark:border-white/10 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
                        ...
                        <div className="mb-12 relative">
                            <div className="inline-block mb-3">
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-gradient-to-r from-[#ffc966]/20 to-[#64c8ff]/20 border border-[#ffc966]/30 dark:border-[#ffc966]/40">
                                    ...
                                    <span className="text-[0.7rem] font-bold text-[#a1804a] dark:text-[#ffc966] tracking-widest uppercase">Email Confirmation</span>
                                </div>
                            </div>
                        ...
                        <form onSubmit={submit} className="space-y-8">
                            ...
                            >
                                ...
                                {verify.isPending ? <Loader size="sm" /> : (
                                    <>
